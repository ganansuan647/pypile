...
def param2(y):
    ...
    """
    a3 = -y**3/6 + y**8/6.72e3 - y**13/9.435e7 + y**18/6.0626e12 - y**23/1.1657e18
    b3 = -y**4/12 + y**9/25920 - y**14/5.1892e8 + y**19/4.2593e13 - y**24/9.8746e18
    c3 = 1 - y**5/40 + y**10/151200 - y**15/4.1912e9 + y**20/4.332e14 - y**25/1.2009e20
    d3 = y - y**6/180 + y**11/1108800 - y**16/4.1513e10 + y**21/5.3354e15 - y**26/1.7543e21
    a4 = -y**2/2 + y**7/840 - y**12/7.257e6 + y**17/3.3681e11 - y**22/5.0683e16
    b4 = -y**3/3 + y**8/2880 - y**13/3.7066e7 + y**18/2.2477e12 - y**23/4.1144e17
