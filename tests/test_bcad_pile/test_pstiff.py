...
class TestPSTIFF(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        """
        # 设置F2PY输出文件的路径
        fortran_file = project_root / "tests" / "test_bcad_pile" / "test_modules" / "pstiff.f"
    ...
    def py_mulult(self, m: int, l: int, n: int, a: np.ndarray, b: np.ndarray) -> np.ndarray:
        """
