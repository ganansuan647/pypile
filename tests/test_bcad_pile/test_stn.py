...
class TestSTN(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        """
        # 设置F2PY输出文件的路径
        fortran_file = project_root / "tests" / "test_bcad_pile" / "test_modules" / "stn.f"
    ...
    def test_stn_simplified(self) -> None:
        ...
        rzz = self.py_stn_simplified(
            ksh, ksu, nfr, hfr, dof, nbl, hbl, dob, 
            pke, peh, pmb, zbl, ao
        )
